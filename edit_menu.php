...
<head>
    ...
    <title>แก้ไขเมนู | FlameMenu</title>
...
<body>
    ...
    <main class="page-container">
        ...
        <div class="breadcrumb">
            ...
            <span>/</span>
            <span class="crumb-current">แก้ไขเมนู <?= $menu['menu_id'] ?></span>
        </div>
        ...
        <section class="form-section">
            <div class="wrap">
                ...
                <div class="section-head">
                    <div class="section-eyebrow">✎ Edit Item</div>
                    <h2>แก้ไข<span class="accent">เมนู <?= $menu['menu_id'] ?></span></h2>
                    <p class="section-sub">ปรับปรุงรายละเอียดของเมนูนี้ให้เป็นปัจจุบัน</p>
                </div>
                ...
                <div class="split-layout">
                    ...
                    <div class="preview-col">
                        ...
                        <div class="menu-card preview-card">
                            <div class="menu-card-media">
                                <span class="menu-card-id" id="pvId"><?= $menu['menu_id'] ?></span>
                                <img id="pvImage" src="<?= $menu['menu_image'] ?>" alt="">
                                <span class="preview-placeholder">🍽️</span>
                            </div>
                            <div class="menu-card-body">
                                <div class="menu-card-type" id="pvType">เมนูทั่วไป</div>
                                <p class="menu-card-name" id="pvName"><?= $menu['menu_name'] ?></p>
                                <div class="menu-card-footer">
                                    <span class="menu-price" id="pvPrice"><?= $menu['menu_price'] ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-col">
                        <div class="form-card">
                            <p class="form-card-heading">✎ แก้ไขรายละเอียดเมนู</p>
                            <form action="action/update_menu.php" method="post">
                                ...
                                <div class="field field-with-icon">
                                    ...
                                    <div class="field-hint">ไม่สามารถแก้ไขรหัสเมนูได้</div>
                                </div>

                                <div class="field field-with-icon">
                                    <label for="menu_name">ชื่อเมนู</label>
                                    <span class="field-icon">🍗</span>
                                    <input type="text" id="menu_name" name="menu_name" value="<?= $menu['menu_name'] ?>" oninput="updatePreview()">
                                </div>

                                <div class="field field-with-icon">
                                    <label for="menu_price">ราคา</label>
                                    <span class="field-icon">฿</span>
                                    <input type="text" id="menu_price" name="menu_price" value="<?= $menu['menu_price'] ?>" oninput="updatePreview()">
                                </div>

                                <div class="field field-with-icon">
                                    <label for="menu_image">ภาพ (ลิงก์รูปภาพ)</label>
                                    <span class="field-icon">🖼️</span>
                                    <input type="text" id="menu_image" name="menu_image" value="<?= $menu['menu_image'] ?>" oninput="updatePreview()">
                                </div>
                                ...
                                <div class="field field-with-icon">
                                    ...
                                    <select id="type_id" name="type_id" onchange="updatePreview()">
                                        <?php foreach($result as $type){ ?>
                                            <option value="<?= $type["type_id"] ?>" data-name="<?= $type["type_name"] ?>" <?= $type["type_id"] == $menu["type_id"] ? "selected" : '' ?>>
                                                <?= $type["type_name"] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <button type="submit" class="btn btn-flame btn-block">บันทึกการแก้ไข</button>
